...
RUN git clone -b test2 https://github.com/manoj-aryal/deep-tam-testing.git && \
	...
	cd ~/deep-tam-testing/tracking/weights && ./download_weights.sh && \
	cd ~/deep-tam-testing/mapping/weights && ./download_weights.sh && \
	cd ~/deep-tam-testing/tracking/data && ./download_testdata.sh 

SHELL ["/bin/bash", "-c"]
RUN conda create -n deep-tam-testing python=3.5 -y
RUN echo "conda activate deep-tam-testing" > ~/.bashrc
ENV PATH /home/docker/miniconda3/envs/deep-tam-testing/bin:$PATH
...
ENV PYTHONPATH $PYTHONPATH:/home/docker/deep-tam-testing/tracking/python:/home/docker/deep-tam-testing/mapping/python:/home/docker/lmbspecialops/python
ENV LD_LIBRARY_PATH /home/docker/miniconda3/envs/deep-tam-testing/lib:/home/docker/miniconda3/lib/:$LD_LIBRARY_PATH
RUN chmod +x /home/docker/deep-tam-testing/install_test.sh
# Launch
ENTRYPOINT ["/home/docker/deep-tam-testing/install_test.sh"]
